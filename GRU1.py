...
input_lang, output_lang, pairs = prepareData('f8', 'fe8')
...
def train(input_tensor, target_tensor, encoder, decoder, encoder_optimizer, decoder_optimizer, criterion, max_length=MAX_LENGTH):
    ...
    if use_teacher_forcing:
        ...
        # Avem la intrare predictia decodorului
...
def trainIters(encoder, decoder, n_iters, print_every=1000, plot_every=100, learning_rate=0.0001):
    ...
    encoder_optimizer = optim.Adam(params=encoder.parameters(), lr=learning_rate)
    ...
    torch.save({
                ...
                'optim_e':encoder_optimizer.state_dict(),
                'optim_d':decoder_optimizer.state_dict(),
            },'gru.pth.tar'
            )  
